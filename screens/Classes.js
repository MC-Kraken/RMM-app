    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                <View>
                    <Card
                        containerStyle={{ borderWidth: 3, borderColor: 'rgb(249, 15, 28)' }}
                        ...
                        <Button
                            buttonStyle={{ backgroundColor: 'white', borderColor: 'rgb(249, 15, 28)', borderWidth: 2 }}
                            title='View Now' onPress={() => this.props.navigation.navigate('Pie')}
                            titleStyle={{ color: 'rgb(249, 15, 28)' }}
                    />
                    </Card>
                    <Card
                        containerStyle={{ borderRadius: 10, borderWidth: 3, borderColor: 'rgb(249, 15, 28)' }}
